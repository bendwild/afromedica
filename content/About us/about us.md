...
- **Education**: Our AfroAcademy offers structured modules on racial bias in healthcare, used by individuals and institutions alike. Our journal clubs and podcasts are well-established, and we provide ongoing training to healthcare professionals.
    
- **Policy**: We co-develop clinical guidelines and recommendations and collaborate with organizations like Domus Medica, KCE, Unia, and academic institutions.
...
AfroMedica operates as a horizontal, collective organization led by a dedicated board. We practice shared leadership—each board member actively helps shape the organization’s direction. The chair and vice-chair provide overall coordination and are responsible for maintaining strategic alignment.

### General Assembly

We hold monthly meetings to review progress and align on next steps. Each working group is represented to ensure continuity and efficiency. Roles such as moderator, timekeeper, and note-taker rotate to ensure clarity and participation.

### Working Groups

Working groups are the backbone of AfroMedica. Each group focuses on a specific domain, contributes to long-term goals, and is reviewed annually. Communication happens via dedicated WhatsApp channels, while documents and planning are organized through SharePoint.

Our current working groups include:

- **Chair & Vice-Chair**: Coordinate strategy, partnerships, and internal operations.
    
- **PR & Communications**: Ensure visibility and consistent branding via social media and design.
...
- **AfroMedica Talks** _(starting 2025)_: Organize events, podcasts, and journal clubs to promote knowledge exchange.
    
- **Afro-Academy**: Develop educational modules and manage our knowledge base.
